...
public class CategoryRepoImpl implements CategoryDomainRepo {
    ...
    public CategoryModel update(String categoryName, String brandId, String id) {
        ...
        // Use .get() because it return optional
        CategoryModel categoryModel = getById(id).get();
        categoryModel.setCategoryName(categoryName);
        categoryModel.setBrandId(UUID.fromString(brandId));
        categoryModel.setUuid(categoryModel.getUuid());

        // map to entity
        CategoryEntity categoryEntity = categoryRepoMapper.toCategoryEntity(categoryModel);
        categoryEntity.setUuid(UUID.fromString(id));
